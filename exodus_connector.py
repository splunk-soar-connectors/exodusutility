...
class ExodusConnector(phantom.BaseConnector):
    ...
    def _swap_playbook_cache(self, repo_id):
        ...
        playbook_url = f'rest/playbook?_filter_scm={repo_id}&_filter_tags__contains="prod"&page_size=0'
    ...
    def _get_playbooks(self, repo_id, ignore_playbooks):
        ...
        playbook_endpoint = f'rest/playbook?_filter_scm={repo_id}&_filter_tags__contains="prod"&_exclude_id__in={ignore_playbooks}&page_size=0'
    ...
    def _create_playbook_artifact(self, playbook_json):
        ...
        artifact = {
            "cef": {"playbook_name": playbook_json["name"], "playbook_id": playbook_json["id"]},
            "label": "playbook",
    ...
    def _create_function_artifact(self, function_json):
        ...
        artifact = {
            "cef": {"custom_function_name": function_json["name"], "custom_function_id": function_json["id"]},
    ...
    def _add_comment(self, container_id, comment_string):
        ...
        comment = {"container_id": container_id, "comment": comment_string}
    ...
    def _create_asset_artifact(self, asset_name):
        ...
        artifact = {
            "cef": {"asset_name": asset_json["name"], "asset_id": asset_json["id"]},
            "label": "asset",
    ...
    def _create_approval_container(self, artifacts):
        ...
        container = {"artifacts": artifacts, "data": {}, "label": "exodus", "name": "Prod Request", "container_type": "default"}
        try:
    ...
    def _get_unresolved_containers(self):
        ...
        if tenant is not None:
            endpoint = (
                f'rest/container?_exclude_status=3&_filter_label="exodus"&_filter_tenant={self.get_config()["source_tenant_id"]}&page_size=0'
            )
        else:
            endpoint = 'rest/container?_exclude_status=3&_filter_label="exodus"'
    ...
    def _is_container_approved(self, container_id):
        ...
        endpoint = (
            f"rest/container/{container_id}/artifacts"
